...
<script type="text/javascript">
    function deleteConfirm(id) {
        if (confirm('¿Esta realmente segur@ de Eliminar?')) {
            window.location.href = "categoria/delete" + "/" + id;
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="<?php echo base_url('categoria/edit')."/".$row->idCategoria; ?>"><i class="icon-file-pdf" ></i> Modificar</a></li>
                                                <li><a href="#" onclick="deleteConfirm(<?php echo $row->idCategoria; ?>)"><i class="icon-file-excel"></i> Eliminar</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="text" class="form-control input-xlg" placeholder="nombre categoria" id="txtNombreCategoria" name="txtNombreCategoria">
